        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-8">
          ...
          <div className="bg-gray-800 p-6 rounded-lg text-center">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <a href="https://www.linkedin.com/in/drew-demarois-2260a8286/" target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300">
                <FaLinkedin size={24} />
              </a>
            </div>
          </div>
          ...
          <div className="bg-gray-800 p-6 rounded-lg text-center">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <a href="www.linkedin.com/in/shane-baird-3349b8331" target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300">
                <FaLinkedin size={24} />
              </a>
            </div>
          </div>
